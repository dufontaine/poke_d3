  ...
  chart: function() {
    ...
    function radar(selection) {
      selection.each(function(data) {
        ...
        var tooltipX = container.selectAll('.tooltip').data([1]).enter().append('text').attr('class', 'tooltip');//////////////
